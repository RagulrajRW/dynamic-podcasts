...
output_wav_path = '/Users/srragulraj/Desktop/Random walk podcast/audio.wav'
output_mp3_path = '/Users/srragulraj/Desktop/Random walk podcast/audio.mp3'
...
while True:
    ...
    try:
        ...
        _, wav_out = mars5.tts(model_response, dummy_audio, ref_transcript, cfg=cfg)
        ...
        ipd.display(ipd.Audio(output_mp3_path))
